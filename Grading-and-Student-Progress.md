...
1. Review the student's work
   ...
   1. If the solution comes with a rubric, use the rubric to double check that the students solution meets all of the requirements. If something is missing, do NOT use the rubric as feedback. Tell the student directly what elements are missing.
